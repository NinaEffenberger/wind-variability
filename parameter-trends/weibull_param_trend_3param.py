...
np.save("data/weibull_params/3_param/cs_kelmarsh.npy", cs)
np.save("data/weibull_params/3_param/scales_kelmarsh.npy", scales)
np.save("data/weibull_params/3_param/locs_kelmarsh.npy", locs)
...
np.save("data/weibull_params/3_param/cs_penmanshiel.npy", cs)
np.save("data/weibull_params/3_param/scales_penmanshiel.npy", scales)
np.save("data/weibull_params/3_param/locs_penmanshiel.npy", locs)
...
np.save("data/weibull_params/3_param/cs_nwtc5.npy", cs)
np.save("data/weibull_params/3_param/scales_nwtc5.npy", scales)
np.save("data/weibull_params/3_param/locs_nwtc5.npy", locs)
...
np.save("data/weibull_params/3_param/cs_owez.npy", cs)
np.save("data/weibull_params/3_param/scales_owez.npy", scales)
np.save("data/weibull_params/3_param/locs_owez.npy", locs)
...
np.save("data/weibull_params/3_param/cs_aachen.npy", cs)
np.save("data/weibull_params/3_param/scales_aachen.npy", scales)
np.save("data/weibull_params/3_param/locs_aachen.npy", locs)
...
np.save("data/weibull_params/3_param/cs_zugspitze.npy", cs)
np.save("data/weibull_params/3_param/scales_zugspitze.npy", scales)
np.save("data/weibull_params/3_param/locs_zugspitze.npy", locs)
...
np.save("data/weibull_params/3_param/cs_boltenhagen.npy", cs)
np.save("data/weibull_params/3_param/scales_boltenhagen.npy", scales)
np.save("data/weibull_params/3_param/locs_boltenhagen.npy", locs)
...
np.save("data/weibull_params/3_param/cs_fichtelberg.npy", cs)
np.save("data/weibull_params/3_param/scales_fichtelberg.npy", scales)
np.save("data/weibull_params/3_param/locs_fichtelberg.npy", locs)
