...
np.save("data/weibull_params/3_param_instantaneous/cs_kelmarsh.npy", cs)
np.save("data/weibull_params/3_param_instantaneous/scales_kelmarsh.npy", scales)
np.save("data/weibull_params/3_param_instantaneous/locs_kelmarsh.npy", locs)
...
np.save("data/weibull_params/3_param_instantaneous/cs_penmanshiel.npy", cs)
np.save("data/weibull_params/3_param_instantaneous/scales_penmanshiel.npy", scales)
np.save("data/weibull_params/3_param_instantaneous/locs_penmanshiel.npy", locs)
...
np.save("data/weibull_params/3_param_instantaneous/cs_nwtc5.npy", cs)
np.save("data/weibull_params/3_param_instantaneous/scales_nwtc5.npy", scales)
np.save("data/weibull_params/3_param_instantaneous/locs_nwtc5.npy", locs)
...
np.save("data/weibull_params/3_param_instantaneous/cs_owez.npy", cs)
np.save("data/weibull_params/3_param_instantaneous/scales_owez.npy", scales)
np.save("data/weibull_params/3_param_instantaneous/locs_owez.npy", locs)
...
np.save("data/weibull_params/3_param_instantaneous/cs_aachen.npy", cs)
np.save("data/weibull_params/3_param_instantaneous/scales_aachen.npy", scales)
np.save("data/weibull_params/3_param_instantaneous/locs_aachen.npy", locs)
...
np.save("data/weibull_params/3_param_instantaneous/cs_zugspitze.npy", cs)
np.save("data/weibull_params/3_param_instantaneous/scales_zugspitze.npy", scales)
np.save("data/weibull_params/3_param_instantaneous/locs_zugspitze.npy", locs)
...
np.save("data/weibull_params/3_param_instantaneous/cs_boltenhagen.npy", cs)
np.save("data/weibull_params/3_param_instantaneous/scales_boltenhagen.npy", scales)
np.save("data/weibull_params/3_param_instantaneous/locs_boltenhagen.npy", locs)
...
np.save("data/weibull_params/3_param_instantaneous/cs_fichtelberg.npy", cs)
np.save("data/weibull_params/3_param_instantaneous/scales_fichtelberg.npy", scales)
np.save("data/weibull_params/3_param_instantaneous/locs_fichtelberg.npy", locs)
