...
stats.probplot(day, dist=gamma(a=cs[4], loc=locs[4], scale=scales[4]), plot=ax[0, 4])
...
stats.probplot(day, dist=gamma(a=cs[4], loc=locs[4], scale=scales[4]), plot=ax[1, 4])
...
stats.probplot(day, dist=gamma(a=cs[4], loc=locs[4], scale=scales[4]), plot=ax[2, 4])
...
stats.probplot(day, dist=gamma(a=cs[4], loc=locs[4], scale=scales[4]), plot=ax[3, 4])
...
stats.probplot(day, dist=gamma(a=cs[4], loc=locs[4], scale=scales[4]), plot=ax[4, 4])
...
stats.probplot(day, dist=gamma(a=cs[4], loc=locs[4], scale=scales[4]), plot=ax[5, 4])
...
stats.probplot(day, dist=gamma(a=cs[4], loc=locs[4], scale=scales[4]), plot=ax[set, 4])
