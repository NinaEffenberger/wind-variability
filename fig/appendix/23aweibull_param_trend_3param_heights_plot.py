...
ax[0, 0].text(0.03, 0.9, "(3a)", transform=ax[0, 0].transAxes)
ax[0, 1].text(0.03, 0.9, "(3b)", transform=ax[0, 1].transAxes)
ax[0, 2].text(0.03, 0.9, "(3c)", transform=ax[0, 2].transAxes)

ax[1, 0].text(0.03, 0.9, "(4a)", transform=ax[1, 0].transAxes)
ax[1, 1].text(0.03, 0.9, "(4b)", transform=ax[1, 1].transAxes)
ax[1, 2].text(0.03, 0.9, "(4c)", transform=ax[1, 2].transAxes)
