...
fig, ax = plt.subplots(2, 4, sharex="col", figsize=(6.5, 4.5), constrained_layout=True, sharey=True)
...
plt.savefig("wind-variability/plots_eps/power_generation_diff_real_cmip6_new.pdf")
plt.show()
